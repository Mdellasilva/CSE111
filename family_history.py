...
# Core Requirements
# 1. Within your program, the print_death_age function must print the 
# name and age at death for each person in the people dictionary.

# 3. The print_marriages function must print the following for each 
...
# 2. The count_genders function must count and print the number of 
# males and the number of females in the people dictionary.
...
def print_marriages(marriages_dict, people_dict):
    ...
    for marriage_key, marriage_list in marriages_dict.items():
        ...
        husband_birth_year = husband_list[BIRTH_YEAR_INDEX]
       
        wife_list = people_dict[wife_key]
        wife_name = wife_list[NAME_INDEX]
        wife_birth_year = wife_list[BIRTH_YEAR_INDEX]

        husband_age = wedding_year - husband_birth_year

        wife_age = wedding_year - wife_birth_year
