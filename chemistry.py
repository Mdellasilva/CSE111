#cse250 data science programming, 350, 451 big data programming and analytics, data structures 212
def main():
    # Get a chemical formula for a molecule from the user.
    chemical_formula = input('Please enter a chemical formula: ')
    # Get a mass in grams from the user.
    mass_in_grams = float(input('Please enter a mass (in grams): '))
    ...
    compound_chemical_list = parse_formula(chemical_formula, periodic_table)
    # Call the compute_molar_mass function to compute the
    # molar mass of the molecule from the compound list.
    mass = compute_molar_mass(compound_chemical_list, periodic_table)
